...
TOOL_POLICY_BY_TASK_TYPE = {
    "research": {"web_search", "search_files", "read_file_content", "get_file_info", "firecrawl_search", "firecrawl_scrape"},
    "read": {"read_file_content", "list_directory", "search_files", "get_file_info"},
    ...
    "analyze": {"read_file_content", "list_directory", "search_files", "get_file_info", "execute_python_code", "web_search"},
...
def infer_task_type(text: str, skill: Any = None) -> str:
    ...
    keyword_map = [
        ("research", ["搜索", "查询", "检索", "查找", "联网", "资料", "最新", "search"]),
